...
/**
 * Registers Item Data Components used by the RPG Systems (Core, Forging, etc).
...
public class ModDataComponents {
    ...
    public static final DeferredRegister<DataComponentType<?>> DATA_COMPONENTS = DeferredRegister
            .create(net.minecraft.core.registries.Registries.DATA_COMPONENT_TYPE, RPGEMCore.MODID);
