...
public class ModAttributes {
    ...
    public static final Holder<Attribute> LIFE_STEAL = ATTRIBUTES.register("life_steal",
            () -> new RangedAttribute("attribute." + RPGEMCore.MODID + ".life_steal", 0.0, 0.0, 1.0).setSyncable(true));
    ...
    public static final Holder<Attribute> ACCURACY = ATTRIBUTES.register("accuracy",
            () -> new RangedAttribute("attribute." + RPGEMCore.MODID + ".accuracy", 0.0, 0.0, 1.0).setSyncable(true));
    ...
    public static final Holder<Attribute> ANTI_HEAL = ATTRIBUTES.register("anti_heal",
            () -> new RangedAttribute("attribute." + RPGEMCore.MODID + ".anti_heal", 0.0, 0.0, 1.0).setSyncable(true));
    ...
    public static final Holder<Attribute> EVASION = ATTRIBUTES.register("evasion",
            () -> new RangedAttribute("attribute." + RPGEMCore.MODID + ".evasion", 0.0, 0.0, 1.0).setSyncable(true));
